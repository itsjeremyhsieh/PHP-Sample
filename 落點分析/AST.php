...
<head>
    ...
    <style>
        ...
        body {
            background-image: url(backgrounds/background_ast.png);
...
<body id="inner_page" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <form action="showAST.php" method="post">
        <div class="block">
            <br>
            <h3 class="golefte">學測成績 </h3>
            ...
            <br>
            <hr class="hr">
            <h3 class="golefte">分科測驗</h3>
            <div id="wrap">

                <div id="div1">
                    數A <input type="text" name="math" value=""></div>
                <div id="div1">
                    歷史 <input type="text" name="history" value="" /></div>
                <div id="div1">
                    地理 <input type="text" name="geo" value="" /></div>
            </div>
            <br>
            <div id="wrap">
                <div id="div1">
                    公民 <input type="text" name="social" value="" /></div>

                <div id="div1">
                    物理 <input type="text" name="physics" value="" /></div>
                <div id="div1">化學 <input type="text" name="chem" value="" /></div>
            </div>
            <br>
            <div id="wrap">
                <div id="div1">生物 <input type="text" name="bio" value="" /></div>
            </div>
            ...
            <div id="wrap">
                ...
                <div id="div1"><input type="checkbox" name="interest[]" value="I"><label>研究型(I)</label></div>
                <div id="div1"><input type="checkbox" name="interest[]" value="A"><label>藝術型(A)</label></div>
                <div id="div1"><input type="checkbox" name="interest[]" value="S"><label>社會型(S)</label></div>
                <div id="div1"><input type="checkbox" name="interest[]" value="E"><label>企業型(E)</label></div>
                <div id="div1"><input type="checkbox" name="interest[]" value="C"><label>事務型(C)</label></div>
            </div>
            ...
            <br>
                ...
                <table width="810">
                <tr>
                <td width="123"><div align="center">北。北。基</div></td>
            ...
            <table width="810">
                <tr>
                <td width="123"><div align="center">桃。竹。苗</div></td>
                ...
                <table width="810">
                    <tr>
                    <td width="123"><div align="center">中。彰。投</div></td>
                    ...
                    <table width="810">
                        <tr>
                        <td width="123"><div align="center">雲。嘉。南</div></td>
                        ...
                        <table width="810">
                        <tr>
                        <td width="123"><div align="center">高。屏。金門</div></td>
                        ...
                        <table width="810">
                            <tr>
                            <td width="123"><div align="center">宜。花。東</div></td>
